...
public class RatingData {
	...
	public RatingData(JSONObject object) {
		super();
		this.filmId = object.getString("filmId");
		this.userId = object.getInt("userId");;
		this.filmDirectionRating = object.getInt("filmDirectionRating");
		this.actorsRating = object.getInt("actorsRating");
		this.globalScoreRating = object.getInt("globalScoreRating");
		this.dialoguesRating = object.getInt("dialoguesRating");
